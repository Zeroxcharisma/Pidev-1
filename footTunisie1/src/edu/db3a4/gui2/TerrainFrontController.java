...
//    }
    ...
    @FXML
    private void watchT(ActionEvent event) throws Exception {
JavaFX_Media s = new JavaFX_Media();
                   String[] args = {};
                   s.main(args);  
            
                   s.launch(Application, args);

    }

    @FXML
    private void Trailerchoose(MouseEvent event) {
    }
