 ...
 */
public class ViewFS extends Canvas implements MouseMotionListener {
    ...
    public ViewFS() {
        try {
            BufferedImage sphereTmpImage = ImageIO.read(getClass().getResourceAsStream("/res/aa.jpg"));
